...
const addEmployee = async (req, res) => {
    try {
        ...
        await db.query(
            "INSERT INTO employee (employeeId, name, userName, password, role, substationId, createdBy) VALUES (?, ?, ?, ?, ?, ?, ?)",
            [employeeId, name, userName, hashedPassword, role, substationId, createdBy]
        );
